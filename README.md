...
## Linked list folder contains C code for different types of linked list data structure like 
...
## Trees folder contains C code for different types of trees data structure like 
1. Normal Tree implementation 
...
## Sorting folder contains C code for sorting algorithms like 
1. Bubble sort  
2. Selection sort
3. Insertion sort
4. Merge sort
